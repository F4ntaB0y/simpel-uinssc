...
const ADMIN_CAMPUS_ZONES = [
    ...
    },
    {
        ...
        name: 'Area Pascasarjana & Ma\'had UIN SSC',
        polygon: [
            [-6.735741, 108.532103], [-6.735328, 108.532041], [-6.735324, 108.53185], [-6.735429, 108.531793], [-6.735661, 108.531724], [-6.735767, 108.531846], [-6.735746, 108.531985], [-6.735726, 108.532169]
        ]
    },
    {
        id: 'area_saladara',
        name: 'Area Kampus Saladara UIN SSC',
        polygon: [
            [-6.74438, 108.525562], [-6.744371, 108.525831], [-6.744221, 108.525832], [-6.744103, 108.525895], [-6.743949, 108.525891], [-6.743796, 108.52589], [-6.74367, 108.525885], [-6.743579, 108.525892], [-6.743671, 108.525619], [-6.743712, 108.525621], [-6.743721, 108.525551], [-6.743724, 108.525508], [-6.743987, 108.525504], [-6.744019, 108.525506], [-6.744017, 108.525553]
        ]
    }
];
...
function initAdminOverviewMap() {
    ...
    try {
        if (!adminOverviewMapInstance) {
            ...
            const holes = ADMIN_CAMPUS_ZONES.map(z => z.polygon);
...
function renderAdminOverviewMarkers() {
    ...
    reportsData.forEach(rep => {
        ...
        if (isNaN(lat) || isNaN(lng) || lng > 108.55) {
            lat = -6.735000;
            lng = 108.533800;
        }
